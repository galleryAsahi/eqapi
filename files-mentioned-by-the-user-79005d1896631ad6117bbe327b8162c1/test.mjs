...
assert.equal(enriched.localIntensities.pointMaxIntensities, undefined);
assert.deepEqual(enriched.localIntensities.cityMaxIntensities[0], {
  code: "0000100",
  name: "City A",
  pref: "Pref A",
  scale: 45,
...
assert.equal(enriched.localIntensities.areaMaxIntensities.length, 1);
assert.equal(enriched.localIntensities.areaMaxIntensities[0].scale, 45);
...
assert.equal(intensityFlash.localIntensities.cityMaxIntensities.length, 0);
assert.deepEqual(intensityFlash.localIntensities.areaMaxIntensities[0], {
  code: "001",
  name: "Area A",
  pref: "Pref A",
  scale: 40,
